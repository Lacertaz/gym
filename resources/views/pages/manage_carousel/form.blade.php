<x-layouts.app :title="$title">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="flex justify-between">
            <h1 class="text-2xl font-bold">Tambah Carousels</h1>
        ...
        <div class="card bg-base-200 p-5 w-full max-w-sm mx-auto">
            <form action="{{ route('manage-carousel.store') }}" method="post" enctype="multipart/form-data">
                ...
                <img id="preview" src="" class="mt-2 w-full h-auto">
